                                    ...
                                    <table class="table table-lg">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-bold-500">{{ $category->articles_count }}</td>
                                                <td>

                                                    <a href="#" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editBeritaModal{{ $category->id }}">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>

                                                    <form action="{{ route('admin.category.destroy', $category) }}" method="POST" class="d-inline delete-article-form">
                                                        @csrf
                                                        @method('DELETE')
...
@include('admin.partials.footer')
    ...
    <script>
      // Optional: Auto-generate slug dari nama kategori
