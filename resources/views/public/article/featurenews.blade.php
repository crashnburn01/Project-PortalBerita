    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <a class="breadcrumb-item" href="#">Ketegori</a>
                <span class="breadcrumb-item active">Feature News</span>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{ asset('portal-assets/img/news-500x280-3.jpg') }}" style="object-fit: cover;">
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        <a href="">Technology</a>
                                        <span class="px-1">/</span>
